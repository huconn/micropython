#define MICROPY_HW_BOARD_NAME       "NUCLEO-G0B1CE"
...
#define MICROPY_HW_UART1_RTS        (pin_B3)
...
#define MICROPY_HW_UART3_RTS        (pin_B1)
#define MICROPY_HW_UART3_CTS        (pin_B0)
// USART4 config
...
#define MICROPY_HW_USRSW_PIN        (pin_D1)
